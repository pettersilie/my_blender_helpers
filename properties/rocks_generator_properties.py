...
class RocksGeneratorProperties(bpy.types.PropertyGroup):
    ...
    scale_factor_x_from : bpy.props.FloatProperty(name='Scale X From', soft_min=-10, soft_max=10,default=1)
    scale_factor_x_to : bpy.props.FloatProperty(name='Scale X To', soft_min=-10, soft_max=10,default=2)
    
    scale_factor_y_from : bpy.props.FloatProperty(name='Scale Y From', soft_min=-10, soft_max=10,default=1)
    scale_factor_y_to : bpy.props.FloatProperty(name='Scale Y To', soft_min=-10, soft_max=10,default=2)
    
    scale_factor_z_from : bpy.props.FloatProperty(name='Scale Z From', soft_min=-10, soft_max=10,default=1)
    scale_factor_z_to : bpy.props.FloatProperty(name='Scale T To', soft_min=-10, soft_max=10,default=2)
